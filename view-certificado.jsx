...
const SOFTWARES = [
  { id: 'semantica', name: 'Semántica Digital', logo: 'assets/nomina/logo-semantica.png',
    desc: 'Portal único, ahora en empleado.co. El enlace cambió: debes registrarte de nuevo para descargar tus desprendibles y tu certificado laboral en Portal Personas.',
    chips: ['Desprendibles', 'Portal Personas'] },
  { id: 'pronos', name: 'Pronos', logo: 'assets/nomina/logo-pronos.png',
    desc: 'Dos accesos independientes: uno para los desprendibles de nómina y otro para tu certificado laboral desde Portal Personas.',
    chips: ['Desprendibles', 'Portal Personas'] },
];
...
function CertificadoView({ go }) {
  ...
  return React.createElement('div', { 'data-screen-label': 'Portal Personas' },
    React.createElement('section', { className: 'a1s-dark', style: { background: '#0A0A0C', paddingTop: 'calc(78px + var(--section-y) * .5)', paddingBottom: 'calc(var(--section-y) * .7)', position: 'relative', overflow: 'hidden' } },
      ...
      React.createElement('div', { style: { ...WRAP, position: 'relative', maxWidth: 940 } },
        React.createElement(Reveal, null,
          React.createElement(SectionHead, { dark: true, eyebrow: 'Portal Personas', title: 'Descarga tu certificado laboral y tus desprendibles de nómina en Portal Personas.', lead: 'Si eres o fuiste colaborador de A1S, puedes generar tus documentos en línea, disponibles 24/7 y sin trámites presenciales.' })),
    ...
    React.createElement('section', { style: SECTION },
      React.createElement('div', { style: { ...WRAP, maxWidth: 1020 } },
        React.createElement(Reveal, null,
          React.createElement('div', { className: 'a1s-swnotice' },
            ...
            React.createElement('div', null,
              React.createElement('h2', null, 'Antes de continuar, selecciona tu software de nómina para Portal Personas'),
        ...
        React.createElement(Reveal, { delay: 220, style: { marginTop: 30, display: 'flex', gap: 14, alignItems: 'center', flexWrap: 'wrap', background: 'var(--surface)', border: '1px dashed var(--border-strong)', borderRadius: 'var(--radius-lg)', padding: '22px 28px' } },
          ...
          React.createElement('div', null,
            React.createElement('h3', { style: { margin: 0, fontSize: '1.05rem', fontWeight: 700 } }, '¿No sabes cuál es tu software o no puedes descargar tus documentos en Portal Personas?'),
